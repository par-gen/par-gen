...
reducerStates[712] = 1; // 'state 2' -> Value -> @par-gen.EOF
reducerStates[776] = 1; // 'state 2' -> Value -> WS
reducerStates[936] = 1; // 'state 2' -> Value -> CURLY_CLOSE
reducerStates[968] = 1; // 'state 2' -> Value -> COMMA
reducerStates[1096] = 1; // 'state 2' -> Value -> BRACKET_CLOSE
reducerStates[796] = 1; // 'state 3' -> Value -> @par-gen.EOF
reducerStates[860] = 1; // 'state 3' -> Value -> WS
reducerStates[1020] = 1; // 'state 3' -> Value -> CURLY_CLOSE
reducerStates[1052] = 1; // 'state 3' -> Value -> COMMA
reducerStates[1180] = 1; // 'state 3' -> Value -> BRACKET_CLOSE
reducerStates[880] = 1; // 'state 4' -> Value -> @par-gen.EOF
reducerStates[944] = 1; // 'state 4' -> Value -> WS
reducerStates[1104] = 1; // 'state 4' -> Value -> CURLY_CLOSE
reducerStates[1136] = 1; // 'state 4' -> Value -> COMMA
reducerStates[1264] = 1; // 'state 4' -> Value -> BRACKET_CLOSE
reducerStates[1048] = 1; // 'state 6' -> Value -> @par-gen.EOF
reducerStates[1112] = 1; // 'state 6' -> Value -> WS
reducerStates[1272] = 1; // 'state 6' -> Value -> CURLY_CLOSE
reducerStates[1304] = 1; // 'state 6' -> Value -> COMMA
reducerStates[1432] = 1; // 'state 6' -> Value -> BRACKET_CLOSE
reducerStates[1216] = 1; // 'state 8' -> Value -> @par-gen.EOF
reducerStates[1280] = 1; // 'state 8' -> Value -> WS
reducerStates[1440] = 1; // 'state 8' -> Value -> CURLY_CLOSE
reducerStates[1472] = 1; // 'state 8' -> Value -> COMMA
reducerStates[1600] = 1; // 'state 8' -> Value -> BRACKET_CLOSE
reducerStates[1204] = 1; // 'state 9' -> S -> @par-gen.EOF
reducerStates[1320] = 1; // 'state 10' -> Json -> @par-gen.EOF
reducerStates[1436] = 1; // 'state 11' -> Element -> @par-gen.EOF
reducerStates[1660] = 1; // 'state 11' -> Element -> CURLY_CLOSE
reducerStates[1692] = 1; // 'state 11' -> Element -> COMMA
reducerStates[1820] = 1; // 'state 11' -> Element -> BRACKET_CLOSE
reducerStates[1552] = 1; // 'state 12' -> Value -> @par-gen.EOF
reducerStates[1616] = 1; // 'state 12' -> Value -> WS
reducerStates[1776] = 1; // 'state 12' -> Value -> CURLY_CLOSE
reducerStates[1808] = 1; // 'state 12' -> Value -> COMMA
reducerStates[1936] = 1; // 'state 12' -> Value -> BRACKET_CLOSE
reducerStates[1636] = 1; // 'state 13' -> Value -> @par-gen.EOF
reducerStates[1700] = 1; // 'state 13' -> Value -> WS
reducerStates[1860] = 1; // 'state 13' -> Value -> CURLY_CLOSE
reducerStates[1892] = 1; // 'state 13' -> Value -> COMMA
reducerStates[2020] = 1; // 'state 13' -> Value -> BRACKET_CLOSE
reducerStates[1688] = 2; // 'state 14' -> Element -> @par-gen.EOF
reducerStates[1912] = 2; // 'state 14' -> Element -> CURLY_CLOSE
reducerStates[1944] = 2; // 'state 14' -> Element -> COMMA
reducerStates[2072] = 2; // 'state 14' -> Element -> BRACKET_CLOSE
reducerStates[1804] = 1; // 'state 15' -> Value -> @par-gen.EOF
reducerStates[1868] = 1; // 'state 15' -> Value -> WS
reducerStates[2028] = 1; // 'state 15' -> Value -> CURLY_CLOSE
reducerStates[2060] = 1; // 'state 15' -> Value -> COMMA
reducerStates[2188] = 1; // 'state 15' -> Value -> BRACKET_CLOSE
reducerStates[1888] = 1; // 'state 16' -> Value -> @par-gen.EOF
reducerStates[1952] = 1; // 'state 16' -> Value -> WS
reducerStates[2112] = 1; // 'state 16' -> Value -> CURLY_CLOSE
reducerStates[2144] = 1; // 'state 16' -> Value -> COMMA
reducerStates[2272] = 1; // 'state 16' -> Value -> BRACKET_CLOSE
reducerStates[1972] = 1; // 'state 17' -> Value -> @par-gen.EOF
reducerStates[2036] = 1; // 'state 17' -> Value -> WS
reducerStates[2196] = 1; // 'state 17' -> Value -> CURLY_CLOSE
reducerStates[2228] = 1; // 'state 17' -> Value -> COMMA
reducerStates[2356] = 1; // 'state 17' -> Value -> BRACKET_CLOSE
reducerStates[2140] = 1; // 'state 19' -> Value -> @par-gen.EOF
reducerStates[2204] = 1; // 'state 19' -> Value -> WS
reducerStates[2364] = 1; // 'state 19' -> Value -> CURLY_CLOSE
reducerStates[2396] = 1; // 'state 19' -> Value -> COMMA
reducerStates[2524] = 1; // 'state 19' -> Value -> BRACKET_CLOSE
reducerStates[2308] = 1; // 'state 21' -> Value -> @par-gen.EOF
reducerStates[2372] = 1; // 'state 21' -> Value -> WS
reducerStates[2532] = 1; // 'state 21' -> Value -> CURLY_CLOSE
reducerStates[2564] = 1; // 'state 21' -> Value -> COMMA
reducerStates[2692] = 1; // 'state 21' -> Value -> BRACKET_CLOSE
reducerStates[2360] = 2; // 'state 22' -> Element -> @par-gen.EOF
reducerStates[2584] = 2; // 'state 22' -> Element -> CURLY_CLOSE
reducerStates[2616] = 2; // 'state 22' -> Element -> COMMA
reducerStates[2744] = 2; // 'state 22' -> Element -> BRACKET_CLOSE
reducerStates[2476] = 1; // 'state 23' -> Value -> @par-gen.EOF
reducerStates[2540] = 1; // 'state 23' -> Value -> WS
reducerStates[2700] = 1; // 'state 23' -> Value -> CURLY_CLOSE
reducerStates[2732] = 1; // 'state 23' -> Value -> COMMA
reducerStates[2860] = 1; // 'state 23' -> Value -> BRACKET_CLOSE
reducerStates[2560] = 1; // 'state 24' -> Value -> @par-gen.EOF
reducerStates[2624] = 1; // 'state 24' -> Value -> WS
reducerStates[2784] = 1; // 'state 24' -> Value -> CURLY_CLOSE
reducerStates[2816] = 1; // 'state 24' -> Value -> COMMA
reducerStates[2944] = 1; // 'state 24' -> Value -> BRACKET_CLOSE
reducerStates[2760] = 2; // 'state 26' -> Object -> @par-gen.EOF
reducerStates[2824] = 2; // 'state 26' -> Object -> WS
reducerStates[2984] = 2; // 'state 26' -> Object -> CURLY_CLOSE
reducerStates[3016] = 2; // 'state 26' -> Object -> COMMA
reducerStates[3144] = 2; // 'state 26' -> Object -> BRACKET_CLOSE
reducerStates[3268] = 1; // 'state 29' -> Members -> CURLY_CLOSE
reducerStates[3300] = 1; // 'state 29' -> Members -> COMMA
reducerStates[3276] = 2; // 'state 31' -> Array -> @par-gen.EOF
reducerStates[3340] = 2; // 'state 31' -> Array -> WS
reducerStates[3500] = 2; // 'state 31' -> Array -> CURLY_CLOSE
reducerStates[3532] = 2; // 'state 31' -> Array -> COMMA
reducerStates[3660] = 2; // 'state 31' -> Array -> BRACKET_CLOSE
reducerStates[3648] = 1; // 'state 32' -> Elements -> COMMA
reducerStates[3776] = 1; // 'state 32' -> Elements -> BRACKET_CLOSE
reducerStates[3368] = 3; // 'state 34' -> Element -> @par-gen.EOF
reducerStates[3592] = 3; // 'state 34' -> Element -> CURLY_CLOSE
reducerStates[3624] = 3; // 'state 34' -> Element -> COMMA
reducerStates[3752] = 3; // 'state 34' -> Element -> BRACKET_CLOSE
reducerStates[3600] = 2; // 'state 36' -> Object -> @par-gen.EOF
reducerStates[3664] = 2; // 'state 36' -> Object -> WS
reducerStates[3824] = 2; // 'state 36' -> Object -> CURLY_CLOSE
reducerStates[3856] = 2; // 'state 36' -> Object -> COMMA
reducerStates[3984] = 2; // 'state 36' -> Object -> BRACKET_CLOSE
reducerStates[4108] = 1; // 'state 39' -> Members -> CURLY_CLOSE
reducerStates[4140] = 1; // 'state 39' -> Members -> COMMA
reducerStates[4116] = 2; // 'state 41' -> Array -> @par-gen.EOF
reducerStates[4180] = 2; // 'state 41' -> Array -> WS
reducerStates[4340] = 2; // 'state 41' -> Array -> CURLY_CLOSE
reducerStates[4372] = 2; // 'state 41' -> Array -> COMMA
reducerStates[4500] = 2; // 'state 41' -> Array -> BRACKET_CLOSE
reducerStates[4488] = 1; // 'state 42' -> Elements -> COMMA
reducerStates[4616] = 1; // 'state 42' -> Elements -> BRACKET_CLOSE
reducerStates[4272] = 3; // 'state 44' -> Object -> @par-gen.EOF
reducerStates[4336] = 3; // 'state 44' -> Object -> WS
reducerStates[4496] = 3; // 'state 44' -> Object -> CURLY_CLOSE
reducerStates[4528] = 3; // 'state 44' -> Object -> COMMA
reducerStates[4656] = 3; // 'state 44' -> Object -> BRACKET_CLOSE
reducerStates[4440] = 3; // 'state 46' -> Object -> @par-gen.EOF
reducerStates[4504] = 3; // 'state 46' -> Object -> WS
reducerStates[4664] = 3; // 'state 46' -> Object -> CURLY_CLOSE
reducerStates[4696] = 3; // 'state 46' -> Object -> COMMA
reducerStates[4824] = 3; // 'state 46' -> Object -> BRACKET_CLOSE
reducerStates[4872] = 3; // 'state 50' -> Array -> @par-gen.EOF
reducerStates[4936] = 3; // 'state 50' -> Array -> WS
reducerStates[5096] = 3; // 'state 50' -> Array -> CURLY_CLOSE
reducerStates[5128] = 3; // 'state 50' -> Array -> COMMA
reducerStates[5256] = 3; // 'state 50' -> Array -> BRACKET_CLOSE
reducerStates[5040] = 3; // 'state 52' -> Array -> @par-gen.EOF
reducerStates[5104] = 3; // 'state 52' -> Array -> WS
reducerStates[5264] = 3; // 'state 52' -> Array -> CURLY_CLOSE
reducerStates[5296] = 3; // 'state 52' -> Array -> COMMA
reducerStates[5424] = 3; // 'state 52' -> Array -> BRACKET_CLOSE
reducerStates[5028] = 3; // 'state 53' -> Object -> @par-gen.EOF
reducerStates[5092] = 3; // 'state 53' -> Object -> WS
reducerStates[5252] = 3; // 'state 53' -> Object -> CURLY_CLOSE
reducerStates[5284] = 3; // 'state 53' -> Object -> COMMA
reducerStates[5412] = 3; // 'state 53' -> Object -> BRACKET_CLOSE
reducerStates[5196] = 3; // 'state 55' -> Object -> @par-gen.EOF
reducerStates[5260] = 3; // 'state 55' -> Object -> WS
reducerStates[5420] = 3; // 'state 55' -> Object -> CURLY_CLOSE
reducerStates[5452] = 3; // 'state 55' -> Object -> COMMA
reducerStates[5580] = 3; // 'state 55' -> Object -> BRACKET_CLOSE
reducerStates[5628] = 3; // 'state 59' -> Array -> @par-gen.EOF
reducerStates[5692] = 3; // 'state 59' -> Array -> WS
reducerStates[5852] = 3; // 'state 59' -> Array -> CURLY_CLOSE
reducerStates[5884] = 3; // 'state 59' -> Array -> COMMA
reducerStates[6012] = 3; // 'state 59' -> Array -> BRACKET_CLOSE
reducerStates[5796] = 3; // 'state 61' -> Array -> @par-gen.EOF
reducerStates[5860] = 3; // 'state 61' -> Array -> WS
reducerStates[6020] = 3; // 'state 61' -> Array -> CURLY_CLOSE
reducerStates[6052] = 3; // 'state 61' -> Array -> COMMA
reducerStates[6180] = 3; // 'state 61' -> Array -> BRACKET_CLOSE
reducerStates[6292] = 3; // 'state 65' -> Members -> CURLY_CLOSE
reducerStates[6324] = 3; // 'state 65' -> Members -> COMMA
reducerStates[6408] = 3; // 'state 66' -> Member -> CURLY_CLOSE
reducerStates[6440] = 3; // 'state 66' -> Member -> COMMA
reducerStates[6672] = 3; // 'state 68' -> Elements -> COMMA
reducerStates[6800] = 3; // 'state 68' -> Elements -> BRACKET_CLOSE
reducerStates[6880] = 3; // 'state 72' -> Members -> CURLY_CLOSE
reducerStates[6912] = 3; // 'state 72' -> Members -> COMMA
reducerStates[6996] = 3; // 'state 73' -> Member -> CURLY_CLOSE
reducerStates[7028] = 3; // 'state 73' -> Member -> COMMA
reducerStates[7260] = 3; // 'state 75' -> Elements -> COMMA
reducerStates[7388] = 3; // 'state 75' -> Elements -> BRACKET_CLOSE
reducerStates[7248] = 4; // 'state 76' -> Member -> CURLY_CLOSE
reducerStates[7280] = 4; // 'state 76' -> Member -> COMMA
reducerStates[7416] = 4; // 'state 78' -> Member -> CURLY_CLOSE
reducerStates[7448] = 4; // 'state 78' -> Member -> COMMA
reducerStates[7500] = 4; // 'state 79' -> Member -> CURLY_CLOSE
reducerStates[7532] = 4; // 'state 79' -> Member -> COMMA
reducerStates[7668] = 4; // 'state 81' -> Member -> CURLY_CLOSE
reducerStates[7700] = 4; // 'state 81' -> Member -> COMMA
reducerStates[7752] = 5; // 'state 82' -> Member -> CURLY_CLOSE
reducerStates[7784] = 5; // 'state 82' -> Member -> COMMA
reducerStates[7836] = 5; // 'state 83' -> Member -> CURLY_CLOSE
reducerStates[7868] = 5; // 'state 83' -> Member -> COMMA
