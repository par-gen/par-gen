...
unsigned int *parse(char *input, unsigned int l, unsigned int *stack, unsigned int *tree)
{
...
/**
 * apache_builds.json: ~0.4% branch misses
 * canada.json: ~0.13% branch misses
 * github_events.json: segfaulted
 * package-lock.json: ~0.7% branch misses
 * pull_request.closed.json: ~0.99% branch misses
